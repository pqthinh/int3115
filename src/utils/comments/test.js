...
export default Comments = (props) => {
  ...
  const setLikesModalVisible = (visible) => {
    setState({ likesModalVisible: visible });
  }

  const setEditModalVisible = (visible) => {
    setState({ editModalVisible: visible });
  }
  ...
  const handleLikesTap = (c) => {
    setState({ likesModalData: props.likesExtractor(c) });
          ...
          >
            ...
            <View style={styles.inputSection}>
              <TextInput
                ...
                onChangeText={text => setState({ replyCommentText: text })}
              ...
              <TouchableHighlight
                onPress={() => {
                  ...
                  setState({ replyCommentText: null });
                  Keyboard.dismiss();
                }}
              >
                {renderIcon({
    ...
    <View style={{ flex: 1 }}>
      <View style={styles.inputSection}>
        <TextInput
          ...
          multiline={true}
          onChangeText={text => setState({ newCommentText: text })}
          placeholder={"Write comment"}
          numberOfLines={3}
        />
        <TouchableHighlight
        ...
        <View style={styles.editModalContainer}>
          <View style={styles.editModal}>
            <TextInput
              ...
              onChangeText={text => setState({ editCommentText: text })}
